...
$(document).ready(function(){
    ...
    function nAni(){
        $(".main1 .imgBox").not(":animated").animate({"margin-left" : -wd+"px"}, 800, function(){
            $(".main1 .imgBox li").eq(0).appendTo($(".main1 .imgBox"));
            $(".main1 .imgBox").css("margin-left", "0px");
        });
    };
    function pAni(){
        $(".main1 .imgBox li").eq(cnt-1).prependTo($(".main1 .imgBox"));
        $(".main1 .imgBox").css("margin-left", -wd+"px");
        $(".main1 .imgBox").not(":animated").animate({"margin-left" : "0px"}, 800);
    };
    $(".left").click(function(){
        clearInterval(intv);
        pAni();
